pedras = {
	...
	*/
	...
	desenha:function(){
		...
		{
			if(score.value > 10){
				spritePedras = new Sprite(8, 25, 200, 107, "img/rosquinha.png")
			}
			if (score.value > 20) {
				spritePedras = new Sprite(8, 25, 200, 107, "img/shuriken.png")
			}
			if (score.value > 30) {
				spritePedras = new Sprite(8, 25, 200, 107, "img/tubarao.png")
			}
